...
class Pokemon(commands.Cog):
    ...
    async def pkmn(self, ctx, name: Union[str, int], form: str = None):
        ...
        if len(r) == 1:
            ...
            embed.set_image(
                url=f"https://rotom.app/discord/pkmn/pokemon_icon_{r[0][2]:02s}_{r[0][4]:01s}.png"
            )
            await ctx.send(f"https://rotom.app/discord/pkmn/pokemon_icon_{r[0][2]:02s}_{r[0][4]:01s}.png")
            bAtk = r[0][8]
            bDef = r[0][9]
            bSta = r[0][10]
            cp15 = math.floor(
